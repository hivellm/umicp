# Publish script for UMICP C# SDK to NuGet (PowerShell)
...
Write-Host "📤 Publishing UMICP C# SDK to NuGet..." -ForegroundColor Blue
...
# Success message
$Version = $PackageFile.Name -replace 'HiveLLM\.Umicp\.(.*)\.nupkg', '$1'

Write-Host ""
Write-Host "✅ Package uploaded successfully!" -ForegroundColor Green
Write-Host ""
Write-Host "View on NuGet: https://www.nuget.org/packages/HiveLLM.Umicp/$Version"
Write-Host ""
Write-Host "Install with:"
Write-Host "  dotnet add package HiveLLM.Umicp --version $Version"
Write-Host ""
