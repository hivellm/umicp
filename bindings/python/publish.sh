#!/bin/bash
# Publish script for UMICP Python package
...
echo ""
if [ "$TEST_MODE" = true ]; then
    echo "View on Test PyPI: https://test.pypi.org/project/umicp-python/"
    echo ""
    echo "Install from Test PyPI:"
    echo "  pip install --index-url https://test.pypi.org/simple/ umicp-python"
else
    echo "View on PyPI: https://pypi.org/project/umicp-python/"
    echo ""
    echo "Install from PyPI:"
    echo "  pip install umicp-python"
fi
echo ""
